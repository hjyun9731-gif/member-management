/* ================================================================
   V10 REFERENCE UI DECORATOR 2026-08-30
...
(() => {
  ...
  async function loadMember() {
    ...
    const male = firstNum(s, ['male','male_count','men','gender_male','남성']);
    const female = firstNum(s, ['female','female_count','women','gender_female','여성']);
